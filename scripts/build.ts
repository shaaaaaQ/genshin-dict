...
import { toKotoeriDict, toMacUserDict, toWindowsImeDict, toWnnDict1, toWnnDict2, toSkkDict } from './lib/platform.js';
...
const skkDictFile = path.join(distDir, '原神辞書_skk.txt');
